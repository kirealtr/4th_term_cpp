...
int main() {
  Matrix<std::vector<int>, int, 2, 2> m;
  m[0][1] = 5;
  std::cout << m[0][1] << std::endl;

  Matrix<std::vector<int>, int, 2, 2> m1 = {
    {1, 2},
    {3, 4}
  };
 
  Matrix<std::vector<int>, int, 2, 2> m2;
  m2 = m + m1;
  m = m1 * m2;
  ...
  Matrix<std::deque<int>, int, 3, 1> m3 = {
    {1},
    {3},
    {4}
  };

  Matrix<std::deque<int>, int, 1, 3> m4 = {
    {1, 1, 1 }
  };
  ...
  Matrix<std::deque<int>, int, 1, 3> m5(m4);
  Matrix<std::deque<int>, int, 1, 3> m6(std::move(m4));
